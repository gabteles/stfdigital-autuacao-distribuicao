...
(9003, 9003, 'COMUM', 42, 'distribuidor', SYSDATE, 'DISTRIBUIDO');
...
(9000, 9003, 'Petição inicial', 101, 1, 1, 'JUNTADA', 'PUBLICO');

INSERT INTO distribuicao.peca (seq_peca, seq_processo, dsc_peca, seq_tipo_peca, seq_documento, num_ordem, tip_situacao, tip_visibilidade) VALUES
(9001, 9003, 'Despacho', 1060, 2, 2, 'PENDENTE_JUNTADA', 'PUBLICO');