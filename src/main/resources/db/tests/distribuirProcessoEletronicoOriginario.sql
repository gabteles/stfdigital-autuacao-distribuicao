...
('-4', 1, '-4', 'DT:9000', NULL, 'distribuicao:1:3', NULL, 'distribuir-processo', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);  
...
('-11', 1, '-4', '-4', 'distribuicao:1:3', 'Distribuir Processo', NULL, 'DISTRIBUICAO', 'distribuir-processo', NULL, NULL, NULL, 50, TIMESTAMP '2016-06-02 16:01:08.766', NULL, NULL, 1, NULL, NULL);  
...
('-10', 'distribuicao:1:3', '-4', '-4', 'distribuir-processo', '-11', NULL, 'Distribuir Processo', 'userTask', NULL, TIMESTAMP '2016-06-02 16:01:08.766', NULL, NULL, NULL);          
...
('-11', 'distribuicao:1:3', 'distribuir-processo', '-4', '-4', 'Distribuir Processo', NULL, 'DISTRIBUICAO', NULL, NULL, TIMESTAMP '2016-06-02 16:01:08.766', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);          
