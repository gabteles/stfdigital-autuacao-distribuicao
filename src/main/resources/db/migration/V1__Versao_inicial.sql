...
alter table distribuicao.distribuicao_evento add constraint fk_distribuicao_diev foreign key (seq_distribuicao) references distribuicao.distribuicao(seq_distribuicao);
alter table distribuicao.distribuicao_evento add constraint fk_evento_diev foreign key (seq_evento) references distribuicao.evento(seq_evento);