...
alter table distribuicao.distribuicao add cod_ministro number;
alter table distribuicao.distribuicao add tip_distribuicao varchar2(9);
alter table distribuicao.distribuicao add constraint ck_dist_tip_distribuicao check (tip_distribuicao in ('COMUM', 'PREVENCAO'));
alter table distribuicao.distribuicao add txt_justificativa varchar2(1000);
alter table distribuicao.distribuicao add sig_distribuidor varchar2(30);
alter table distribuicao.distribuicao add dat_distribuicao date;
