...
public class PecaRestAdapterUnitTests {
    ...
    public void dividir() {
        ...
        Mockito.when(documentoRestClient.dividir(1L, command)).thenReturn(Arrays.asList(2L, 3L));
        ...
        Mockito.verify(documentoRestClient, Mockito.times(1)).dividir(1L, command);
    }
